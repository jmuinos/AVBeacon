...
/// <summary>
///     Representa el manejador de la consulta <see cref="GetJobOffersByTitleQuery" />.
/// </summary>
    ...
    GetJobOffersByTitleQueryHandler : IQueryHandler<GetJobOffersByTitleQuery, List<JobOfferResponse>>
{
    ...
    /// <summary>
    ///     Inicializa una nueva instancia de la clase <see cref="GetJobOffersByTitleQueryHandler" />.
    /// </summary>
    /// <param name="dbContext"> El contexto de base de datos. </param>
    public GetJobOffersByTitleQueryHandler(IDbContext dbContext)
    {
