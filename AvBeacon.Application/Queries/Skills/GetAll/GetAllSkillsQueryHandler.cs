...
/// <summary>
///     Representa el manejador de la consulta <see cref="GetAllSkillsQuery" />.
/// </summary>
internal sealed class GetAllSkillsQueryHandler : IQueryHandler<GetAllSkillsQuery, List<SkillResponse>>
{
    ...
    /// <summary>
    ///     Inicializa una nueva instancia de la clase <see cref="GetAllSkillsQueryHandler" />.
    /// </summary>
    /// <param name="dbContext"> El contexto de base de datos. </param>
    public GetAllSkillsQueryHandler(IDbContext dbContext)
    {
