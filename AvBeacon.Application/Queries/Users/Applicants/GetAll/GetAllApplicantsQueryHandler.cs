...
/// <summary>
///     Representa el manejador de la consulta <see cref="GetAllApplicantsQuery" />.
/// </summary>
internal sealed class GetAllApplicantsQueryHandler : IQueryHandler<GetAllApplicantsQuery, Maybe<List<UserResponse>>>
{
    ...
    /// <summary>
    ///     Inicializa una nueva instancia de la clase <see cref="GetAllApplicantsQueryHandler" />.
    /// </summary>
    /// <param name="dbContext"> El contexto de base de datos. </param>
    public GetAllApplicantsQueryHandler(IDbContext dbContext)
    {
