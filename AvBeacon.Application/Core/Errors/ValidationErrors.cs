...
internal static class ValidationErrors
{
    ...
    {
        public static Error ApplicantIdIsRequired { get; set; }
        public static Error SkillIdIsRequired { get; set; }
    }

    internal class CreateEducation
    {
        public static Error InvalidEducationType { get; set; }
        public static Error TitleIsRequired { get; set; }
        public static Error DescriptionIsRequired { get; set; }
        public static Error ApplicantIdIsRequired { get; set; }
    }
    ...
    internal class CreateExperience
    {
        public static Error ApplicantIdIsRequired { get; set; }
        public static Error TitleIsRequired { get; set; }
        public static Error StartMustBeEarlierThanEnd { get; set; }
    }

    internal class CreateJobApplication
    {
        public static Error ApplicantIdIsRequired { get; set; }
        public static Error JobOfferIdIsRequired { get; set; }
    }

    internal class ProcessJobApplication
    {
        public static Error JobApplicationIdIsRequired { get; set; }
        public static Error StateIsRequired { get; set; }
        public static Error InvalidState { get; set; }
    }
