...
/// <summary>
///     Representa el handler de la consulta <see cref="GetEducationsByApplicantIdQuery" />.
/// </summary>
    ...
    : IQueryHandler<GetEducationsByApplicantIdQuery, List<EducationResponse>>
{
    ...
    /// <summary>
    ///     Inicializa una nueva instancia de la clase <see cref="GetEducationsByApplicantIdQueryHandler" />.
    /// </summary>
    /// <param name="dbContext"> El contexto de base de datos. </param>
    public GetEducationsByApplicantIdQueryHandler(IDbContext dbContext)
    {
