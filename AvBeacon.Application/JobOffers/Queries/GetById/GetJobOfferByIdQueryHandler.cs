...
/// <summary> Representa el manejador de consultas para <see cref="GetJobOfferByIdQuery" />. </summary>
internal sealed class GetJobOfferByIdQueryHandler : IQueryHandler<GetJobOfferByIdQuery, Maybe<JobOfferResponse>>
{
    private readonly IDbContext _dbContext;

    /// <summary> Inicializa una nueva instancia de la clase <see cref="GetJobOfferByIdQueryHandler" />. </summary>
    /// <param name="dbContext"> El contexto de la base de datos. </param>
    public GetJobOfferByIdQueryHandler(IDbContext dbContext) { _dbContext = dbContext; }
