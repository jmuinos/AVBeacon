...
internal static class ValidationErrors
{
    ...
    internal static class CreateUser
    {
        internal static Error FirstNameIsRequired =>
            new("CreateUser.FirstNameIsRequired", "The firstname is required.");
    ...
    internal static class UpdateUser
    {
        ...
        internal static Error FirstNameIsRequired =>
            new("UpdateUser.FirstNameIsRequired", "The firstname is required.");

        internal static Error LastNameIsRequired => new("UpdateUser.LastNameIsRequired", "The lastname is required.");
    }

    internal class AddApplicantSkill
    {
        public static Error ApplicantIdIsRequired =>
            new("VinculateSkill.ApplicantIdIsRequired", "The applicant identifier is required.");

        public static Error SkillIdIsRequired =>
            new("VinculateSkill.SkillIdIsRequired", "The skill identifier is required.");
    }
