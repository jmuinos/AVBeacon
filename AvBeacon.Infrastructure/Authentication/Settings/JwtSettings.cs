...
public class JwtSettings
{
    ...
    /// <summary> Initializes a new instance of the <see cref="JwtSettings" /> class. </summary>
    public JwtSettings()
    {
        Issuer = string.Empty;
    ...
    /// <summary> Gets or sets the security key. </summary>
    public string SecurityKey { get; set; }

    /// <summary> Gets or sets the token expiration time in minutes. </summary>
