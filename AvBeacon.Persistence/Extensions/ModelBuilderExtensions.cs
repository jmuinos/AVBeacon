...
internal static class ModelBuilderExtensions
{
    ...
    /// <summary>
    ///     Applies the UTC date-time converter to all the properties that are <see cref="DateTime" /> and end with Utc.
    /// </summary>
    ...
    internal static void ApplyUtcDateTimeConverter(this ModelBuilder modelBuilder)
    {
        ...
        {
            var dateTimeUtcProperties =
                mutableEntityType.GetProperties()
                                 .Where(p =>
