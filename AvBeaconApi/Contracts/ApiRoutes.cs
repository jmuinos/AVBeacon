...
/// <summary> Contains the API endpoint routes. </summary>
public static class ApiRoutes
{
    /// <summary> Contains the authentication routes. </summary>
    ...
    /// <summary> Contains the attendee routes. </summary>
    public static class Attendees
    {
        public const string Get = "attendees";
    }

    /// <summary> Contains the friendship requests routes. </summary>
    ...
    /// <summary> Contains the friendships routes. </summary>
    ...
    /// <summary> Contains the group events routes. </summary>
    ...
    /// <summary> Contains the group invitations routes. </summary>
    ...
    /// <summary> Contains the personal events routes. </summary>
    ...
    /// <summary> Contains the users routes. </summary>
