...
internal class ExceptionHandlerMiddleware
{
    ...
    /// <summary>Invokes the exception handler middleware with the specified <see cref="HttpContext" />.</summary>
    ...
    /// <summary>Handles the specified <see cref="Exception" /> for the specified <see cref="HttpContext" />.</summary>
    /// <param name="httpContext">The HTTP httpContext.</param>
...
/// <summary>Contains extension methods for configuring the exception handler middleware.</summary>
internal static class ExceptionHandlerMiddlewareExtensions
{
    /// <summary>Configure the custom exception handler middleware.</summary>
