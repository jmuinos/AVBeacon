...
public static class DomainErrors
{
    ...
    /// <summary>Contiene los errores de title.</summary>
    public static class Title
    {
        public static Error NullOrEmpty =>
            new("Title.NullOrEmpty", "The title is required.");

        public static Error LongerThanAllowed =>
            new("Title.LongerThanAllowed", "The title is longer than allowed.");
    }

    /// <summary>Contiene los errores de description.</summary>
    public static class Description
    {
        public static Error NullOrEmpty =>
            new("Description.NullOrEmpty", "The description is required.");
    ...
    {
        public static Error NullOrEmpty =>
            new("Name.NullOrEmpty", "The name is required.");

        public static Error LongerThanAllowed =>
            new("Name.LongerThanAllowed", "The name is longer than allowed.");
    }
