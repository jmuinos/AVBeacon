...
namespace AvBeacon.Domain._Core.Abstractions;

public interface IBaseRepository<TEntity> where TEntity : Entity
{
    /// <summary>
    ///     Obtiene la entidad con el identificador especificado.
    /// </summary>
    ...
    /// <summary>
    ///     Inserta la entidad especificada en la base de datos.
    /// </summary>
    /// <param name="entity"> La entidad a insertar en la base de datos. </param>
    void Insert(TEntity entity);

    /// <summary>
    ///     Inserta las entidades especificadas en la base de datos.
    /// </summary>
    ...
    /// <summary>
    ///     Actualiza la entidad especificada en la base de datos.
    /// </summary>
    /// <param name="entity"> La entidad a actualizar. </param>
    void Update(TEntity entity);

    /// <summary>
    ///     Elimina la entidad especificada de la base de datos.
    /// </summary>
