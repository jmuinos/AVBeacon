...
/// <summary>Represents the password value object.</summary>
public sealed class Password : ValueObject
{
    ...
    public static implicit operator string(Password password) { return password?.Value ?? string.Empty; }

    /// <summary>Creates a new <see cref="Password" /> instance based on the specified value.</summary>
