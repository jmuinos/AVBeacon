...
{
    /// <summary>Represents the event that is raised when a users password is changed.</summary>
    public sealed class UserPasswordChangedDomainEvent : IDomainEvent
    {
        /// <summary>Initializes a new instance of the <see cref="UserPasswordChangedDomainEvent" /> class.</summary>
