...
/// <summary>Represents the event that is raised when a users first and last name is changed.</summary>
public sealed class UserNameChangedDomainEvent : IDomainEvent
{
    /// <summary>Initializes a new instance of the <see cref="UserNameChangedDomainEvent" /> class.</summary>
