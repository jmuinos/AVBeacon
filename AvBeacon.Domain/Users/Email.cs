...
/// <summary>Represents the email value object.</summary>
public sealed class Email : ValueObject
{
    /// <summary>The email maximum length.</summary>
    ...
    /// <summary>Creates a new <see cref="Email" /> instance based on the specified value.</summary>
