...
public sealed class Description : ValueObject
{
    ...
    {
        return Result.Create(description, DomainErrors.Descriptions.NullOrEmpty)
                     .Ensure(d => !string.IsNullOrWhiteSpace(d), DomainErrors.Descriptions.NullOrEmpty)
                     .Ensure(d => d.Length <= MaxLength, DomainErrors.Descriptions.LongerThanAllowed)
