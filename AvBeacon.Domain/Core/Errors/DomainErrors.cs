...
public static class DomainErrors
{
    ...
    /// <summary>Contains the attendee errors.</summary>
    public static class Attendee
    {
        public static Error NotFound =>
            new("Attendee.NotFound", "The attendee with the specified identifier was not found.");

        public static Error AlreadyProcessed =>
            new("Attendee.AlreadyProcessed", "The attendee has already been processed.");
    }

    /// <summary>Contains the category errors.</summary>
    ...
    /// <summary>Contains the invitation errors.</summary>
    ...
    /// <summary>Contains the friendship errors.</summary>
    ...
    /// <summary>Contains the friendship request errors.</summary>
    ...
    public static class Authentication
    {
        ...
        public static Error EmailNotFound { get; set; }
        public static Error UserNotFound { get; set; }
    ...
    {
        public static Error NotFound { get; set; }
        public static Error AlreadyInSkillList { get; set; }
    }

    public class Education
    {
        public static Error InvalidEducationType { get; set; }
    }
    ...
    {
        public static Error AlreadyExists { get; set; }
        public static Error NotFound { get; set; }
    }

    public class Description
    {
        public static Error NullOrEmpty { get; set; }
        public static Error LongerThanAllowed { get; set; }
    }
}