...
public sealed class Maybe<T> : IEquatable<Maybe<T>>
{
    ...
    /// <summary>Gets a value indicating whether or not the value exists.</summary>
    public bool HasValue => !HasNoValue;

    /// <summary>Gets a value indicating whether or not the value does not exist.</summary>
    ...
    public static Maybe<T> From(T value) { return new Maybe<T>(value); }

    public static implicit operator Maybe<T>(T value) { return From(value); }
