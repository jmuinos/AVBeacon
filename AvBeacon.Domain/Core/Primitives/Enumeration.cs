...
namespace AvBeacon.Domain.Core.Primitives
{
        ...
        where TEnum : Enumeration<TEnum>
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="Enumeration{TEnum}" /> class.</summary>
        ...
        protected static IReadOnlyCollection<TEnum> List => EnumerationsDictionary.Value.Values.ToList();
        ...
        public static bool ContainsValue(int value) { return EnumerationsDictionary.Value.ContainsKey(value); }
        ...
        {
            if (obj is not Enumeration<TEnum> otherValue) return false;
