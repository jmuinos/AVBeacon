...
/// <summary> Represents the first name value object. </summary>
public sealed class FirstName : ValueObject
{
    /// <summary> The first name maximum length. </summary>
    public const int MaxLength = 100;

    /// <summary> Initializes a new instance of the <see cref="FirstName" /> class. </summary>
    /// <param name="value"> The first name value. </param>
    private FirstName(string value) { Value = value; }

    /// <summary> Gets the first name value. </summary>
    public string Value { get; }

    public static implicit operator string(FirstName firstName) { return firstName.Value; }
    ...
    {
        return Result.Create(firstName, DomainErrors.FirstName.NullOrEmpty)
