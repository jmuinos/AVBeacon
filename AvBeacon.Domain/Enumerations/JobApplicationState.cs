...
namespace AvBeacon.Domain.Enumerations;

/// <summary> Represents the job application state enumeration. </summary>
public sealed class JobApplicationState : Enumeration<JobApplicationState>
{
    ...
    public static readonly JobApplicationState Denied = new(2, "Denied");

    /// <summary> Initializes a new instance of the <see cref="JobApplicationState" /> class. </summary>
